...
const PRECIO_RUMI_PRO = "L. 3,000/mes";
...
export default function PagoRumiProModal({
  onCancelar,
  onConfirmar,
}: {
  onCancelar: () => void;
      ...
      >
        <div className="flex items-center justify-between">
          <h3 className="flex items-center gap-2 font-display text-lg font-bold text-moorcado-gray-dark">
            <CreditCard className="h-5 w-5 text-moorcado-brown" />
            Activar Rumi Pro
          </h3>
          <button
            type="button"
        ...
        <div className="mt-5 space-y-3">
          <label className="block">
            ...
            <input
              ...
              className="w-full rounded-xl border border-black/10 bg-moorcado-gray-light px-4 py-2.5 text-sm outline-none focus:border-moorcado-brown focus:ring-2 focus:ring-moorcado-brown/20"
            />
          </label>
        ...
        <div className="mt-5 flex gap-2">
          ...
          <button
            ...
            className="flex-1 rounded-full bg-moorcado-brown py-3 text-sm font-bold text-white disabled:opacity-40"
          >
