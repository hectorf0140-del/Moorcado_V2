...
/**
 * Pago simulado al aceptar una oferta — mismo patrón que PagoPlanModal
 * (sin integración real de Stripe/PayPal/etc, a propósito), pero
 * parametrizado por un monto en lempiras y el animal en vez de un plan.
 * `onConfirmar` es quien de verdad marca el anuncio como vendido.
 */
export default function PagoOfertaModal({
  monto,
  animalNombre,
  error,
  onCancelar,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setProcesando(true);
    // Simula el tiempo de procesamiento de la pasarela de pago — igual que
    // PagoPlanModal, esta app no tiene integración real todavía.
