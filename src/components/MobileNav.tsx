...
import { Home, Grid2x2, Plus, User, Map } from "lucide-react";

// Mensajes no va aquí: el ícono del header (arriba) ya da acceso a
// /mensajes en todas las pantallas, incluido mobile — tenerlo también acá
// duplicaba la misma interacción dos veces.
const items = [
